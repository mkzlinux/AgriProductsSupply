...
<html lang="en">
  <head>
    ...
    <title>AgriSupplyChain - FarmBlock</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to FarmBlock - The Agricultural Products Supply Chain Traceability System DAPP</h4>
            <p style="max-width: 80%;">
                 FarmBlock is a DApp that stores the whereabouts of agricultural product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
                 <br>
                 Designed by Tinotenda Gwiriri, HBSCTC Student of The University of Zimbabwe class of 2019 
            </p>
